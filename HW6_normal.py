...
teachers = [
    Teacher('Jukov', 'Ilia', 'Alexandrovich', 'Java',
            ['1J', '2J', '1P']),
    Teacher('Zotov', 'Alex', 'Olegovich', 'Python',
            ['1P', '2P', '2J'])]


students = [
    Student('Semenov', 'Semen', 'Semenovich', '1P', 'Semenov S.S.', 'Semenova А. В.'),
    Student('Ilin', 'Andrey', 'Semenovich', '1P', 'Ilin S.D.', 'Ilina T.N.'),
    Student('Kushnikov', 'Mark', 'Gazizovich', '1P', 'Kushnikov G.A.', 'Kushnikova S.А.'),
    Student('Savelev', 'Alex', 'Ivanovich', '1P', 'Savelev I.К.', 'Saveleva V.V.'),
    Student('Putin', 'Vladimir', 'Vladimirovich', '1P', 'Putin V.А.', 'Putina А.Т'),
    Student('Medvedev', 'Dmitriy', 'Anatolievich', '1P', 'Medvedev A.D', 'Medvedeva A.X.')]
...
student = school.find_student('Medvedev Dmitriy Anatolievich')
